...
<div class="row">
    <div class="col-md-6">
        <img src="${product.thumbnailImagePath}" class="img-fluid rounded-3 shadow-lg mb-5 w-100" alt="${product.productName}">
        <div class="row g-3">
            <c:forEach var="imagePath" items="${product.detailImagePaths}">
                <div class="col-3">
                    <img src="${imagePath}" class="img-thumbnail" style="height: 100%; width: 100px; object-fit: contain;">
                </div>
            </c:forEach>
        </div>
    </div>
    <div class="col-md-5">
        ...
        <div class="d-grid gap-2">
            <form action="/cart/add.do" method="post" class="d-grid">
                ...
                <button type="submit" class="btn btn-primary btn-lg" ${product.stock <= 0 || sessionScope.user.userAuth == "ROLE_ADMIN" ? 'disabled' : ''}>
                    장바구니 담기
                </button>
            </form>
